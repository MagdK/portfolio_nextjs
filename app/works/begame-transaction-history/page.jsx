...
import img8 from './Transaction_08.png'
    ...
    return (
        <div className={styles.details_content_wrapper}>
            ...
            <div className={styles.work_description}>
                ...
                <Image src={img3}
                    title="List of users&#39; needs" alt="What do users want" />
                ...
                <p>I created wireframes to outline key layout variations for the
                    ...
                    concepts.</p>
                <Image src={img4} title="Concepts of new transaction" alt="Wiewframe" />
                ...
                <p>Once the direction was decided, I developed high-fidelity prototypes
                    ...
                    sizes.</p>
                <Image src={img6}
                    title="Preview of all breakpoints and how cards were set up"
                    alt="Breakpoints" />
                <h2 id="error-handeling-and-empty-states">Error handeling and empty
                    states</h2>
                <p>I designed mockups for errors, empty states, and edge cases,
